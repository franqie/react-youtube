...
import {FaBars, FaEllipsisV, FaMicrophone, FaRegUserCircle, FaSearch} from "react-icons/fa";
    ...
    <nav className="navbar">
        <div className="navbar-center">
            ...
            <div className="center">
                ...
                <button type="button" className="mic srch-btn"><FaSearch className="icon"/></button>                
                <button type="button" className="mic"><FaMicrophone className="icon"/></button>                
            </div>
